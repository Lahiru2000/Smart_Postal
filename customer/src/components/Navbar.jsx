...
import { Menu, X, Package, User, Mail, Phone, LogOut, ChevronDown } from 'lucide-react';
        ...
        <div className="flex items-center justify-between h-16">
          ...
          <Link to="/" className="flex items-center gap-3 group">
            ...
            <div className="flex items-center gap-2">
              ...
              <span className="text-[9px] bg-[#FFC000] text-black px-2 py-0.5 rounded font-extrabold uppercase tracking-wider">Customer</span>
            </div>
          </Link>
                    ...
                    <div className="relative p-6 pb-5 bg-gradient-to-br from-[#1A1A1A] to-[#111111]">
                      ...
                      <div className="flex items-center gap-4 relative">
                        ...
                        <div className="min-w-0">
                          ...
                          <span className="text-[10px] bg-[#FFC000]/15 text-[#FFC000] px-2 py-0.5 rounded font-bold uppercase tracking-wider inline-block mt-1">Customer</span>
                        </div>
                      </div>
                    </div>
