  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-[#f0f4f8] p-4">
      <div className="max-w-5xl w-full bg-white rounded-3xl shadow-2xl overflow-hidden flex flex-col md:flex-row">
        ...
        {/* Left Side - Illustration (Identical to Login for consistency) */}
        ...
        <div className="w-full md:w-1/2 p-8 md:p-16 flex flex-col justify-center">
          <div className="mb-8">
            <h2 className="text-3xl font-bold text-[#1e3a8a] mb-2">Create an Account</h2>
            <p className="text-slate-500 italic text-lg">Join us and Ship Smarter</p>
          </div>
